...
public class BaiduReportPageMongoSaveProcessor implements PageProcessor {
    ...
    public BaiduReportPageMongoSaveProcessor(){

    }

    public BaiduReportPageMongoSaveProcessor(String projectId, String projectName, String keyWord){
...
//        Spider.create(new GithubRepoPageProcessor()).addUrl("https://github.com/code4craft").thread(5).run();
        ...
        Spider.create(new BaiduReportPageMongoSaveProcessor()).setDownloader(new HttpClientDownloader()).addUrl(url).thread(1).run();
    }
}