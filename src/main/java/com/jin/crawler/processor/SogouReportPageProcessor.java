...
public class SogouReportPageProcessor implements PageProcessor {
    ...
    public SogouReportPageProcessor(){

    }

    public SogouReportPageProcessor(ReportMapper reportMapper){
        this.reportMapper = reportMapper;
    }

    public SogouReportPageProcessor(ReportMapper reportMapper,String projectId,String projectName,String keyWord){
        this.reportMapper = reportMapper;
...
//        Spider.create(new GithubRepoPageProcessor()).addUrl("https://github.com/code4craft").thread(5).run();
        ...
        Spider.create(new SogouReportPageProcessor()).setDownloader(new HttpClientDownloader()).addUrl(url).thread(1).run();
    }
}